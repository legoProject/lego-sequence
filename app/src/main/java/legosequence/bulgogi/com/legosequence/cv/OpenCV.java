package legosequence.bulgogi.com.legosequence.cv;
...
public class OpenCV {
    ...
    static public void BitmapToIplImage(final Bitmap bitmap, final opencv_core.IplImage image) {
        bitmap.copyPixelsToBuffer(image.getByteBuffer());
    }

    static public opencv_core.IplImage getThresholdedImageHSV(IplImage bgra, CvScalar start, CvScalar end, boolean blur) {
